glossary = {
    ...
    'bool': 'Python bool() function is used to return or convert a value'
        ' to a Boolean value i.e., True or False, using the standard truth testing procedure.',
    'None': 'None keyword is an object, and it is a data type of the class NoneType .',
    'title': 'Title() is the Python String Method which is used to convert'
        ' the first character in each word to Uppercase and remaining characters'
        ' to Lowercase in the string and returns a new string.',
    'cycle': 'cycle() Iterator is defined as object types which contains values'
        ' that can be accessed or iterated using a loop.',
    'operator': 'Operators are used to perform operations on values and variables.',
    }
